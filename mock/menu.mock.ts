...
export default defineMock([
  {
    url: '/apis/system/menu/getMenusByRole',
    enabled: true,
    method: 'GET',
    body(request) {
            ...
            children: [
              {
                id: '11239',
                name: 'essential-data',
                path: '/essential/customerManage',
                component: 'essential/CustomerManage',
                route: '1',
                meta: {
                  keepAlive: false,
                  icon: '',
              ...
              },
              {
                id: '11239',
                name: 'essential-data',
                path: '/essential/shippingAccount',
                component: 'essential/ShippingAccount',
                route: '1',
                meta: {
                  keepAlive: false,
                  icon: '',
