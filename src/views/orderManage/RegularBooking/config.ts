...
export const RegularBookingDetailBaseInfoOptions: RegularBookingDetailBaseInfoType[] =
  [
    {
      label: '订单编号',
      key: 'orderNo',
...
export const RegularBookingStatusOptions: RegularBookingStatusOptionsType = {
  payStatus: {
    UNPAID: '待支付',
    // PAID: "已支付"
  },
